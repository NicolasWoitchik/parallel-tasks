...
describe('ImportOrRequireFile - Essential Tests', () => {
    ...
    it('should handle different file extensions', async () => {
      ...
      for (const ext of extensions) {
        try {
          ...
          const mockFilePath = require.resolve('../../globals'); // Use existing TS file
          ...
          // If file doesn't exist, that's expected for some extensions
  ...
  describe('💯 Coverage Enhancement Tests', () => {
    it('should handle file:// URLs in import path', async () => {
      // Test with an .mjs file to force it to use import and test file:// branch
      const mockFilePath = require.resolve('../../globals').replace('.ts', '.mjs');
      const fileUrl = `file://${require.resolve('../../globals')}`;
